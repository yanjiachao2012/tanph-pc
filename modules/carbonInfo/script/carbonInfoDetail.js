...
$(function() {
	$.ajax({
		type: "post",
		url: path() + "/foreignHall/getHallInfo.do",
		dataType: "json",
		data: {
			id: cid
		},
		success: function(res) {
			var html = '';
			var createDate = new Date(res.createdDate).formatDate("yyyy-MM-dd");
			html += '<div class="details-title"><h1>' + res.infoTitle + '</h1>';
			html += '<div class="item-info">';
			html += '<a href="" class="item-user"><i class="icon-user"></i>中国新作者</a>';
			...
			$("#carbonInfoDetail-content").append(html);
		}
	});
});